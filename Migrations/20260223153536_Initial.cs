...
namespace puzzle_alloc.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MaxCapacityPerContainer = table.Column<int>(type: "int", nullable: false),
                    EnforceCategorySeparation = table.Column<bool>(type: "bit", nullable: false),
                    GhostContainerCount = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Allocations_Containers_ContainerId",
                        column: x => x.ContainerId,
                        principalTable: "Containers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Allocations_Items_ItemId",
                        column: x => x.ItemId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Allocations_ContainerId",
                table: "Allocations",
                column: "ContainerId");

            migrationBuilder.CreateIndex(
                name: "IX_Allocations_ItemId",
                table: "Allocations",
                column: "ItemId");
